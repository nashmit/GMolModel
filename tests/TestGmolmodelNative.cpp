...
int main(int argc, char **argv)
{
    ...
    coords = new TARGET_TYPE*[world->mr->natoms];
    TARGET_TYPE **vels = new TARGET_TYPE*[world->mr->natoms];
    TARGET_TYPE **inivels = new TARGET_TYPE*[world->mr->natoms];
    TARGET_TYPE **grads = new TARGET_TYPE*[world->mr->natoms];
