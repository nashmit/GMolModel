...
parser.add_argument('--mols', default=["2but"], nargs='+',
  help='Molecules.')
parser.add_argument('--restart', default='ligand.inpcrd',
...
inpFilenames = args.nsims * [None]
outFilenames = args.nsims * [None]
...
DISTANCE 0 618
DIHEDRAL 304 306 308 314 306 308 314 316
